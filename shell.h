...
/**
 * struct passinfo - encapsulates arguments to be passed into a function,
 * ensuring a consistent prototype for a function pointer struct
 ...
 * Olatunji and Goodnews
 * @env_changed: set to true if environ was changed
 * @status: the return status of the last executed command
 * @cmd_buf: address of a pointer to cmd_buf, set if chaining commands
